...
# course: 0 = random, 1-13 = 1-13
# amount: desired number of exercises
# min: lower bound of exercises to be picked from
# max: higher bound of exercises to be picked from
# custom_range: 0 = random, 1 = specific range defined by min, max

def main(course, amount, min, max, custom_range):
